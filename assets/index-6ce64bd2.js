...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function da(){return new bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ns(),fragmentShader:`
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function pa(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ns(),fragmentShader:`
